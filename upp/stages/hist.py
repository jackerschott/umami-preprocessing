...
def create_histograms(config) -> None:
    ...
    resampling_variables = config.resampling_config.vars
    for component in config.components:
        ...
        jets = component.get_jets(resampling_variables, config.num_jets_estimate_hist, cuts_no_split)
        component.hist.write_hist(jets, resampling_variables, config.resampling_config.flat_bins)
